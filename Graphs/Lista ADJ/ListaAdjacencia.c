...
void InserirVertices(ListaAdj *vet[]){
	criarVerticeADJ(vet[0],1,0);
     	criarVerticeADJ(vet[0],3,0);
     	criarVerticeADJ(vet[1],2,0);
	criarVerticeADJ(vet[2],3,0);
	criarVerticeADJ(vet[3],1,0);
	criarVerticeADJ(vet[4],2,0);
	criarVerticeADJ(vet[4],5,0);
	criarVerticeADJ(vet[5],5,0);
